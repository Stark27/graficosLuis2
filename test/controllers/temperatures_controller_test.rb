...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post temperatures_url, params: { temperature: { hora: @temperature.hora, temperatura: @temperature.temperatura } }
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { hora: @temperature.hora, temperatura: @temperature.temperatura } }
